  ...
  return (
    <Section name="Chat" color="#4187C0" id="chat" className="mb-7 lg:mb-9">
      <div className="flex flex-col flex-1">
        ...
        <div className="flex flex-col flex-1">
        <h3 className="text-xl font-semibold text-foreground mb-1 mt-7 text-left flex gap-1 items-center">Use cases</h3>
        <p className="text-base text-muted-foreground text-left">
        Below are some of the use cases for Sigma Chat:
        <ul className="list-disc ml-6 mt-2">
          <li className="mb-3">
            <span className="font-semibold">Walk into 1-1s fully briefed</span><br />
            <span className="italic">"Show me Harshith's last-month GitHub + Jira work."</span><br />
            <span className="text-xs">↳ Sigma drops ticket counts, PRs, and DORA metrics straight onto your 1-1 page.</span>
          </li>
          <li className="mb-3">
            <span className="font-semibold">Audit outreach in seconds</span><br />
            <span className="italic">"Score my outbound emails from the past two weeks, 1-10."</span><br />
            <span className="text-xs">↳ Sigma rates each email, highlights wins, and suggests fixes.</span>
          </li>
          <li className="mb-3">
            <span className="font-semibold">Get any insights on demand</span><br />
            <span className="italic">One ask surfaces velocity trends, blocker threads, or customer feedback—no noise, just answers.</span>
          </li>
        </ul>
        </p>

        <h3 className="text-xl font-semibold text-foreground mb-1 mt-7 text-left flex gap-1 items-center">How it works</h3>
        <p className="text-base text-muted-foreground text-left">
          Sigma connects to your tools via MCP servers, giving the AI live access to data—no tabs, no copy-paste, just one chat that acts on your behalf.
        </p>
      </div>
